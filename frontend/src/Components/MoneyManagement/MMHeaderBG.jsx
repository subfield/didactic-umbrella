...
import MMBG from '../../assets/Images/MMBG.svg';
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:  
              `linear-gradient(to right, rgba(148, 0, 85, 0.6), rgba(148, 0, 85, 0.3)), url(${MMBG})`,
          }}
        ></div>
        ...
        <div className="relative flex flex-col justify-center items-start px-8 lg:px-20 h-full pt-40 text-white w-full lg:w-1/2">
          ...
          Manage Your Wealth, Maximize Your Potential
          </h1>
          <p className="text-lg lg:text-xl mb-6">
          At Crystal Bricks, our clients gain more than access to our core products and services—they benefit from expert brokerage services.
          </p>
